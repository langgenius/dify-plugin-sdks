...
class ChatUpdatedV1Event(Event):
    def _on_event(self, request: Request, parameters: Mapping[str, Any]) -> Variables:
        ...
        if event_data.before_change:
            ...
            variables_dict["before_change"] = json.dumps(before_dict, ensure_ascii=False)
        else:
        ...
        if event_data.after_change:
            ...
            variables_dict["after_change"] = json.dumps(after_dict, ensure_ascii=False)
        else:
        ...
        if event_data.moderator_list:
            ...
            variables_dict["moderator_changes"] = json.dumps(moderator_changes, ensure_ascii=False)
        else:
