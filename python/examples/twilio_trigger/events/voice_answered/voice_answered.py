...
class VoiceAnsweredEvent(Event):
    """Handle voice call answered events."""

    def _on_event(self, request: Request, parameters: dict[str, Any], payload: dict[str, Any]) -> Variables:
        """Process voice answered webhook and apply filters."""
