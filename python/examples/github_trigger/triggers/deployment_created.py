...
class DeploymentCreatedTrigger(TriggerEvent):
    """
    GitHub DeploymentCreated Event Trigger

    This trigger handles GitHub deployment created events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub deployment created event trigger
        """
