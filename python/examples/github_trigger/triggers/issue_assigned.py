...
class IssueAssignedTrigger(TriggerEvent):
    """
    GitHub Issue Assigned Event Trigger
    
    This trigger handles GitHub issue assigned events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub issue assigned event trigger
        ...
        # Verify this is an assigned action
