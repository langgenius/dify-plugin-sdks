...
class PullRequestUnassignedTrigger(TriggerEvent):
    """
    GitHub Pull Request Pull Request Unassigned Event Trigger

    This trigger handles GitHub pull request unassigned events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub pull request unassigned event trigger
        ...
        # Verify this is a unassigned action
