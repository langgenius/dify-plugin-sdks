...
class PullRequestReopenedTrigger(TriggerEvent):
    """
    GitHub Pull Request Reopened Event Trigger

    This trigger handles GitHub pull request reopened events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub pull request reopened event trigger
        ...
        # Verify this is a reopened action
            ...
            "pull_request": {
                ...
                "head": {
                    ...
                    "repo": {
                        ...
                        "html_url": pull_request.get("head", {}).get("repo", {}).get("html_url", ""),
                    },
                },
                "base": {
                    ...
                    "repo": {
                        ...
                        "html_url": pull_request.get("base", {}).get("repo", {}).get("html_url", ""),
                    },
                },
                "labels": labels,
                "assignees": [
