...
class DiscussionCreatedTrigger(TriggerEvent):
    """
    GitHub DiscussionCreated Event Trigger

    This trigger handles GitHub discussion created events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub discussion created event trigger
        """
