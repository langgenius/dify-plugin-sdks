...
class IssueCommentDeletedTrigger(TriggerEvent):
    """
    GitHub Issue Comment Deleted Event Trigger
    
    This trigger handles GitHub issue comment deletion events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub issue comment deleted event trigger
