...
class ReleaseUnpublishedTrigger(TriggerEvent):
    """
    GitHub Release Release Unpublished Event Trigger

    This trigger handles GitHub release unpublished events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub release unpublished event trigger
        ...
        # Verify this is a unpublished action
        action = payload.get("action", "")
        if action != "unpublished":
            # This trigger only handles unpublished events
