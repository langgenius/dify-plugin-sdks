...
class PackagePublishedTrigger(TriggerEvent):
    """
    GitHub PackagePublished Event Trigger

    This trigger handles GitHub package published events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub package published event trigger
        """
