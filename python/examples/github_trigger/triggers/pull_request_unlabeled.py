...
class PullRequestUnlabeledTrigger(TriggerEvent):
    """
    GitHub Pull Request Pull Request Unlabeled Event Trigger

    This trigger handles GitHub pull request unlabeled events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub pull request unlabeled event trigger
        ...
        # Verify this is a unlabeled action
