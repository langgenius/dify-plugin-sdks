...
class ReleaseDeletedTrigger(TriggerEvent):
    """
    GitHub Release Release Deleted Event Trigger

    This trigger handles GitHub release deleted events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub release deleted event trigger
