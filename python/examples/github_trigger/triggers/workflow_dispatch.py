...
class WorkflowDispatchTrigger(TriggerEvent):
    """
    GitHub WorkflowDispatch Event Trigger

    This trigger handles GitHub workflow dispatch events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub workflow dispatch event trigger
        """
