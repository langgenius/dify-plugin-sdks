...
class PullRequestReviewCommentEditedTrigger(TriggerEvent):
    """
    GitHub Pull Request Review Comment Pull Request Review Comment Edited Event Trigger

    This trigger handles GitHub pull request review comment edited events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub pull request review comment edited event trigger
