...
class LabelDeletedTrigger(TriggerEvent):
    """
    GitHub LabelDeleted Event Trigger

    This trigger handles GitHub label deleted events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub label deleted event trigger
        """
