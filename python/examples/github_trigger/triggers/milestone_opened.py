...
class MilestoneOpenedTrigger(TriggerEvent):
    """
    GitHub MilestoneOpened Event Trigger

    This trigger handles GitHub milestone opened events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub milestone opened event trigger
        """
