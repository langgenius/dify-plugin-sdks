...
class IssueReopenedTrigger(TriggerEvent):
    """
    GitHub Issue Reopened Event Trigger
    
    This trigger handles GitHub issue reopened events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub issue reopened event trigger
