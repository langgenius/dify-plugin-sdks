...
class PullRequestReviewCommentDeletedTrigger(TriggerEvent):
    """
    GitHub Pull Request Review Comment Pull Request Review Comment Deleted Event Trigger

    This trigger handles GitHub pull request review comment deleted events and extracts relevant
    information from the webhook payload to provide as variables to the workflow.
    """

    def _trigger(self, request: Request, parameters: Mapping[str, Any]) -> Event:
        """
        Handle GitHub pull request review comment deleted event trigger
        ...
        # Verify this is a deleted action
        action = payload.get("action", "")
        if action != "deleted":
            # This trigger only handles deleted events
