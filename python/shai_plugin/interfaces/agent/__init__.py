...
from shai_plugin.entities.model import AIModelEntity, ModelPropertyKey
...
from shai_plugin.entities.tool import ToolDescription, ToolIdentity, ToolParameter, ToolProviderType
from shai_plugin.interfaces.tool import ToolLike, ToolProvider
