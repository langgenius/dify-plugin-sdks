...
from shai_plugin.entities.model import EmbeddingInputType
from shai_plugin.entities.model.text_embedding import TextEmbeddingModelConfig, TextEmbeddingResult
